...
public final class TorControl implements AutoCloseable {
	...
	private final void readLoop() {
		while(!Thread.currentThread().isInterrupted()) {
			try {
				...
				// TODO: Remove
				//System.out.println("[TOR CONTROL] " + line);
	...
	private static final class ConnectionWaiter {
		...
		private final Property<Integer> circuitId = new Property<>(ID_UNKNOWN);
		...
		public boolean release() throws IOException {
			...
			listener.forgetCircuit(circuitId.getValue());
